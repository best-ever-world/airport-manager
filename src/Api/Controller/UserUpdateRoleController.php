...
use BestEverWorld\AirportManager\Api\Request\UserUpdateRoleRequest;
...
#[AsController]
class UserUpdateRoleController
{
    ...
    #[
        ...
        IsGranted(
            attribute: UserGroupModel::UPDATE_ROLE,
            subject: 'user',
            message: 'Forbidden',
        ...
        OA\RequestBody(
            content: [
                new OA\XmlContent(
                    ref: new Model(
                        type: UserUpdateRoleRequest::class,
                        groups: [
    ...
    public function index(
        ...
        UserUpdateRoleRequest $userUpdateRoleRequest,
    ): Response {
        ...
        try {
            ...
            $user->setRoles([
                UserRoleModel::ROLE_USER,
                $userUpdateRoleRequest->getRole(),
            ]);
             ...
             */
            $this->eventDispatcher->dispatch(new UserRoleUpdateEvent($user));
